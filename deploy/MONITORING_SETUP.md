...
| `seo-output-freshness` | pg-freshness | seo_agent-DB: ältestes un-actioniertes Insight älter als letzte Ausgabe (Issue/PR) < 168h (7 Tage) — erkennt, wenn Insights vorhanden aber keine GitHub-Ausgabe erzeugt wird (#1683) | 1 h | 9 min |
